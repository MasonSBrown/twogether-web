...
export default function Home() {
  ...
  return (
    <div className={styles.page}>
      <Head>
        <title>Twogether — Stay close, even when you're miles apart</title>
        <meta name="description" content="Twogether keeps couples close with heartfelt widgets: love notes, photos, distance updates and milestones." />
      ...
      <main className={styles.container}>
        ...
        <section className={styles.hero}>
          <div className={styles.heroText}>
            ...
            <p className={styles.subheadline}>Send love notes, photos, and live distance updates through beautiful home‑screen widgets designed for couples.</p>
